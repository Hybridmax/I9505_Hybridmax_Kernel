...
2. Get previous version of GT-I9505_EUR open source code
...
4. Copy module that you want to build - to original android open source
...
5. You should add module name to 'PRODUCT_PACKAGES' in 'build\target\product\core.mk' as following case.
	...
	case 6) strongswan : should add 'charon', 'libcharon', 'libhydra', 'libstrongswan' to PRODUCT_PACKAGES
